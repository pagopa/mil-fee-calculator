        ...
        return Stream.of(
                ...
                Arguments.of(setAndGet(FeeCalculatorTestData.getFeeRequest(), "notices",
                        List.of(setAndGet(FeeCalculatorTestData.getNotice(), "transfers",
                                List.of(setAndGet(FeeCalculatorTestData.getTransfer(""), "paTaxCode", null)))) ), ErrorCode.TRANSFERS_PA_TAX_CODE_MUST_NOT_BE_NULL),
                Arguments.of(setAndGet(FeeCalculatorTestData.getFeeRequest(), "notices",
                        List.of(setAndGet(FeeCalculatorTestData.getNotice(), "transfers",
                                List.of(setAndGet(FeeCalculatorTestData.getTransfer(""), "paTaxCode", "ABC")))) ), ErrorCode.TRANSFERS_PA_TAX_CODE_MUST_MATCH_REGEXP),
                Arguments.of(setAndGet(FeeCalculatorTestData.getFeeRequest(), "notices",
                        List.of(setAndGet(FeeCalculatorTestData.getNotice(), "transfers",
                                List.of(setAndGet(FeeCalculatorTestData.getTransfer(""), "category", null)))) ), ErrorCode.TRANSFERS_CATEGORY_MUST_NOT_BE_NULL),
                Arguments.of(setAndGet(FeeCalculatorTestData.getFeeRequest(), "notices",
                        List.of(setAndGet(FeeCalculatorTestData.getNotice(), "transfers",
                                List.of(setAndGet(FeeCalculatorTestData.getTransfer(""), "category", "€")))) ), ErrorCode.TRANSFERS_CATEGORY_MUST_MATCH_REGEXP)
        );
    }
//
