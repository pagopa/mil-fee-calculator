...
public final class ErrorCode {
	...
	public static final String PAYMENT_METOD_MUST_NOT_BE_NULL					= MODULE_ID + "000002";
	...
	public static final String AMOUNT_EXEED_MAX_VALUE							= MODULE_ID + "000007";
	
	public static final String PATAXCODE_MUST_MATCH_REGEXP	 					= MODULE_ID + "000008";
	public static final String PATAXCODE_MUST_NOT_BE_NULL						= MODULE_ID + "000009";
	...
	public static final String TRANSFERS_PATAXCODE_MUST_NOT_BE_NULL				= MODULE_ID + "00000E";
	public static final String TRANSFERS_PATAXCODE_MUST_MATCH_REGEXP			= MODULE_ID + "00000F";
