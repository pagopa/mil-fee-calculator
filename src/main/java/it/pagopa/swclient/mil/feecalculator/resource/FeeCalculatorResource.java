...
public class FeeCalculatorResource {
	...
	/**
	 * API to retrieve the commissions fees. It retrieves the PSP id value from an API exposed by MIL
	 * and invokes the GEC service to retrieve the fees.
	 *
	 * @param headers       a set of mandatory headers
	 * @param getFeeRequest the {@link GetFeeRequest} containing the payment notices for which to
	 *                      retrieve the fees
